...
huggin_face_api_token = os.getenv('HUGGINGFACEHUB_API_TOKEN')
llm = HuggingFaceHub(repo_id="google-t5/t5-large", model_kwargs={"temperature": 0.7}, huggingfacehub_api_token=huggin_face_api_token)
